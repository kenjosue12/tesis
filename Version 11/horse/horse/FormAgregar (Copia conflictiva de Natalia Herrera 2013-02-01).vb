...
Public Class FormAgregar
    ...
    Private Sub FormAgregar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Call ObUtilidades.Cargar_Combo(CBraza, "select descripcion from raza order by descripcion desc;")
        Call ObUtilidades.Cargar_Combo(CBandar, "select descripcion from andares order by descripcion desc;;")
        Call ObUtilidades.Cargar_Combo(CbcolorPelaje, "select descripcion from colores order by descripcion desc;;")
        Call ObUtilidades.Cargar_Combo(CBasociacion, "select descripcion from asociaciones order by descripcion desc;;")
        Call ObUtilidades.Cargar_Combo(CBservicios, "select descripcion from servicios order by descripcion desc;;")
        ObUtilidades.Cargar_Combo(CBpersonas, "select  nombres from personas order by nombres asc;")
        ...
        CBandar.Text = "Seleccione una opción..."
        CBandar.ForeColor = Color.DarkGray
        CBraza.Text = "Seleccione una opción..."
        CBraza.ForeColor = Color.DarkGray
        CBsexos.Text = "Seleccione una opción..."
        CBsexos.ForeColor = Color.DarkGray
        CbcolorPelaje.Text = "Seleccione una opción..."
        CbcolorPelaje.ForeColor = Color.DarkGray
        CBservicios.Text = "Seleccione una opción..."
        CBservicios.ForeColor = Color.DarkGray
        CBestado.Text = "Seleccione una opción..."
        CBestado.ForeColor = Color.DarkGray
        CBasociacion.Text = "Seleccione una opción..."
        CBasociacion.ForeColor = Color.DarkGray
        CBpersonas.Text = "Seleccione un propietario..."
        CBpersonas.ForeColor = Color.DarkGray
    End Sub
    ...
    Private Sub TB_padre_caballo_Click(sender As Object, e As EventArgs) Handles TB_padre_caballo.Click 'asignamos el papa del caballo
        ...
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "papa", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "papa")
            If auxi.Equals("Sin Asignar") Then
                TB_padre_caballo.ForeColor = Color.DarkGray
                TB_padre_caballo.Text = auxi
            Else
                TB_padre_caballo.Text = auxi
            End If
    ...
    Private Sub TB_madre_caballo_Click(sender As Object, e As EventArgs) Handles TB_madre_caballo.Click 'para asignar la mama del caballo
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "mama", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "mama")
            If auxi.Equals("Sin Asignar") Then
                TB_madre_caballo.ForeColor = Color.DarkGray
                TB_madre_caballo.Text = auxi
            Else
                TB_madre_caballo.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox12_Click(sender As Object, e As EventArgs) Handles TB_abuelop.Click 'para asignar el abuelo paterno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "abuelop", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "abuelop")
            If auxi.Equals("Sin Asignar") Then
                TB_abuelop.ForeColor = Color.DarkGray
                TB_abuelop.Text = auxi
            Else
                TB_abuelop.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox6_Click(sender As Object, e As EventArgs) Handles TB_abuelap.Click ' para asignar la abuela paterna
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "abuelap", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "abuelap")
            If auxi.Equals("Sin Asignar") Then
                TB_abuelap.ForeColor = Color.DarkGray
                TB_abuelap.Text = auxi
            Else
                TB_abuelap.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox13_Click(sender As Object, e As EventArgs) Handles TB_abuelom.Click ' para asignar el abuelo materno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "abuelom", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "abuelom")
            If auxi.Equals("Sin Asignar") Then
                TB_abuelom.ForeColor = Color.DarkGray
                TB_abuelom.Text = auxi
            Else
                TB_abuelom.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox16_Click(sender As Object, e As EventArgs) Handles TB_abualam.Click ' para asignar la abuela materna
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "abuelam", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "abuelam")
            If auxi.Equals("Sin Asignar") Then
                TB_abualam.ForeColor = Color.DarkGray
                TB_abualam.Text = auxi
            Else
                TB_abualam.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox17_Click(sender As Object, e As EventArgs) Handles TB_bis_pat_p.Click ' para asignar el bisabuelo paterno paterno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelopp", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelopp")
            If auxi.Equals("Sin Asignar") Then
                TB_bis_pat_p.ForeColor = Color.DarkGray
                TB_bis_pat_p.Text = auxi
            Else
                TB_bis_pat_p.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox18_Click(sender As Object, e As EventArgs) Handles TB_bisa_pat_p.Click ' para asginar la bisabuela paterna paterna
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabulapp", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelapp")
            If auxi.Equals("Sin Asignar") Then
                TB_bisa_pat_p.ForeColor = Color.DarkGray
                TB_bisa_pat_p.Text = auxi
            Else
                TB_bisa_pat_p.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox20_Click(sender As Object, e As EventArgs) Handles TB_bis_m_p.Click 'paraa asignar el bisabuelo materna paterna
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelomp", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelomp")
            If auxi.Equals("Sin Asignar") Then
                TB_bis_m_p.ForeColor = Color.DarkGray
                TB_bis_m_p.Text = auxi
            Else
                TB_bis_m_p.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox19_Click(sender As Object, e As EventArgs) Handles TB_bisa_mat_p.Click 'paraa asignar la bisabuela materna paterna
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelamp", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelamp")
            If auxi.Equals("Sin Asignar") Then
                TB_bisa_mat_p.ForeColor = Color.DarkGray
                TB_bisa_mat_p.Text = auxi
            Else
                TB_bisa_mat_p.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox22_Click(sender As Object, e As EventArgs) Handles TB_bis_pat_m.Click ' para asignar el bisabuelo paterno materno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelopm", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelopm")
            If auxi.Equals("Sin Asignar") Then
                TB_bis_pat_m.ForeColor = Color.DarkGray
                TB_bis_pat_m.Text = auxi
            Else
                TB_bis_pat_m.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox21_Click(sender As Object, e As EventArgs) Handles TB_bisa_pat_m.Click ' para asignar la bisabuela paterno materno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelapm", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelapm")
            If auxi.Equals("Sin Asignar") Then
                TB_bisa_pat_m.ForeColor = Color.DarkGray
                TB_bisa_pat_m.Text = auxi
            Else
                TB_bisa_pat_m.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox24_Click(sender As Object, e As EventArgs) Handles TB_bis_mat_m.Click ' para asignar el bisabuelo materno materno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelomm", "M")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelomm")
            If auxi.Equals("Sin Asignar") Then
                TB_bis_mat_m.ForeColor = Color.DarkGray
                TB_bis_mat_m.Text = auxi
            Else
                TB_bis_mat_m.Text = auxi
            End If
        End If
    ...
    Private Sub TextBox23_Click(sender As Object, e As EventArgs) Handles TB_bisa_mat_m.Click ' para asignar la bisabuela materno materno
        ...
        If caball.Equals("") Then
            ...
            TabControl1.SelectTab(0)
        Else
            genea = New Agre_cab_genealogia(LB_id_caballo.Text, "bisabuelamm", "F")
            genea.ShowDialog()
            Dim auxi As String = traer_pariente(LB_id_caballo.Text, "bisabuelamm")
            If auxi.Equals("Sin Asignar") Then
                TB_bisa_mat_m.ForeColor = Color.DarkGray
                TB_bisa_mat_m.Text = auxi
            Else
                TB_bisa_mat_m.Text = auxi
            End If
        End If
    ...
    'COMPORTAMIENTO COMBOBOX ANDAR, PARA 'SELECCIONE UNA OPCION'
    Private Sub CBandar_DropDownClosed(sender As Object, e As EventArgs) Handles CBandar.DropDownClosed
        CBandar.Text = "Seleccione una opción..."
        CBandar.ForeColor = Color.DarkGray
    End Sub
    Private Sub CBandar_DropDown(sender As Object, e As EventArgs) Handles CBandar.DropDown 'ocurre cuando se despliega la lista 
        CBandar.ForeColor = Color.Black
    End Sub
    Private Sub CBandar_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBandar.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBandar.ForeColor = Color.Black
    End Sub
    
    'COMPORTAMIENTO COMBOBOX RAZA, PARA 'SELECCIONE UNA OPCION'
    Private Sub CBraza_DropDown(sender As Object, e As EventArgs) Handles CBraza.DropDown 'ocurre cuando se despliega la lista 
        CBraza.ForeColor = Color.Black
    End Sub
    Private Sub CBraza_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBraza.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBraza.ForeColor = Color.Black
    End Sub
    Private Sub CBraza_DropDownClosed(sender As Object, e As EventArgs) Handles CBraza.DropDownClosed
        CBraza.Text = "Seleccione una opción..."
        CBraza.ForeColor = Color.DarkGray
    End Sub

    'COMPORTAMIENTO COMBOBOX COLOR PELAJE, PARA 'SELECCIONE UNA OPCION'
    Private Sub Cbcolorpelaje_DropDown(sender As Object, e As EventArgs) Handles CbcolorPelaje.DropDown 'ocurre cuando se despliega la lista 
        CbcolorPelaje.ForeColor = Color.Black
    End Sub
    Private Sub Cbcolorpelaje_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CbcolorPelaje.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CbcolorPelaje.ForeColor = Color.Black
    End Sub
    Private Sub CbcolorPelaje_DropDownClosed(sender As Object, e As EventArgs) Handles CbcolorPelaje.DropDownClosed
        CbcolorPelaje.Text = "Seleccione una opción..."
        CbcolorPelaje.ForeColor = Color.DarkGray
    End Sub
    'COMPORTAMIENTO COMBOBOX SERVICIOS, PARA 'SELECCIONE UNA OPCION'
    Private Sub CBservicios_DropDown(sender As Object, e As EventArgs) Handles CBservicios.DropDown 'ocurre cuando se despliega la lista 
        CBservicios.ForeColor = Color.Black
    End Sub
    Private Sub CBservicios_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBservicios.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBservicios.ForeColor = Color.Black
    End Sub
    Private Sub CBservicios_DropDownClosed(sender As Object, e As EventArgs) Handles CBservicios.DropDownClosed
        CBservicios.Text = "Seleccione una opción..."
        CBservicios.ForeColor = Color.DarkGray
    End Sub
    'COMPORTAMIENTO COMBOBOX ESTADO, PARA 'SELECCIONE UNA OPCION'
    Private Sub Cbestado_DropDown(sender As Object, e As EventArgs) Handles CBestado.DropDown 'ocurre cuando se despliega la lista 
        CBestado.ForeColor = Color.Black
    End Sub
    Private Sub Cbestado_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBestado.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBestado.ForeColor = Color.Black
    End Sub
    Private Sub Cbestado_DropDownClosed(sender As Object, e As EventArgs) Handles CBestado.DropDownClosed
        CBestado.Text = "Seleccione una opción..."
        CBestado.ForeColor = Color.DarkGray
    End Sub
    'COMPORTAMIENTO COMBOBOX PROPIETARIOS, PARA 'SELECCIONE UNA OPCION'
    Private Sub Cbpersonas_DropDown(sender As Object, e As EventArgs) Handles CBpersonas.DropDown 'ocurre cuando se despliega la lista 
        CBpersonas.ForeColor = Color.Black
    End Sub
    Private Sub Cbpersonas_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBpersonas.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBpersonas.ForeColor = Color.Black
    End Sub
    Private Sub Cbpersonas_DropDownClosed(sender As Object, e As EventArgs) Handles CBpersonas.DropDownClosed
        CBpersonas.Text = "Seleccione una opción..."
        CBpersonas.ForeColor = Color.DarkGray
    End Sub
    'COMPORTAMIENTO COMBOBOX SEXOS, PARA 'SELECCIONE UNA OPCION'
    Private Sub CbSexos_DropDown(sender As Object, e As EventArgs) Handles CBsexos.DropDown 'ocurre cuando se despliega la lista 
        CBsexos.ForeColor = Color.Black
    End Sub
    Private Sub CBsexos_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBsexos.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBsexos.ForeColor = Color.Black
    End Sub
    Private Sub CBsexos_DropDownClosed(sender As Object, e As EventArgs) Handles CBsexos.DropDownClosed
        CBsexos.Text = "Seleccione una opción..."
        CBsexos.ForeColor = Color.DarkGray
    End Sub
    'COMPORTAMIENTO COMBOBOX ASOCIACIONES, PARA 'SELECCIONE UNA OPCION'
    Private Sub CBasociacion_DropDown(sender As Object, e As EventArgs) Handles CBasociacion.DropDown 'ocurre cuando se despliega la lista 
        CBasociacion.ForeColor = Color.Black
    End Sub
    Private Sub CBasociacion_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBasociacion.SelectedIndexChanged 'ocurre cuando cambia el select index, o sea se selecciono un item
        CBasociacion.ForeColor = Color.Black
    End Sub
    Private Sub CBasociacion_DropDownClosed(sender As Object, e As EventArgs) Handles CBasociacion.DropDownClosed
        CBasociacion.Text = "Seleccione una opción..."
        CBasociacion.ForeColor = Color.DarkGray
    End Sub
End Class